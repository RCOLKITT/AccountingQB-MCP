...
export function welcomeEmail(params: WelcomeEmailParams): {
  ...
  const content = `
    ...
    ${infoBox("Your data never leaves your machine. AccountingQB runs locally and connects directly to QuickBooks — we never see or store your financial data.", "info")}
