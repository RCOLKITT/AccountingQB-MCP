...
export function qbConnectedEmail(params: QbConnectedEmailParams): {
  ...
  const content = `
    ...
    ${paragraph("Just open Claude Desktop and start asking questions about your books. AccountingQB gives Claude 108 tools to help with everything from reports to reconciliation.")}
