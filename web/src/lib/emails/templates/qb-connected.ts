...
export function qbConnectedEmail(params: QbConnectedEmailParams): {
  ...
  const content = `
    ...
    ${infoBox("Your connection is secure and your data stays local. Claude accesses QuickBooks directly from your machine.", "success")}
    ...
    ${paragraph("Just open Claude Desktop and start asking questions about your books. AccountingQB gives Claude 91 tools to help with everything from reports to reconciliation.")}
