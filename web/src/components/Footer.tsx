    ...
    <footer className="border-t border-white/[0.06] bg-[#0a0e1a]">
      <div className="mx-auto max-w-6xl px-6 py-14">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-gray-500">
              AI-powered QuickBooks — bookkeeping, reporting, and US &amp;
              Canadian tax prep for Claude. Your books stay local or transit
              with zero retention.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-gray-500">
              ...
              <li>
                <a href="/canada" className="transition hover:text-white">
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-3 border-t border-white/[0.06] pt-8 text-sm text-gray-600 sm:flex-row">
          ...
          <span>
            Not affiliated with Intuit Inc. QuickBooks is a trademark of Intuit
            Inc.
          </span>
        </div>
      </div>
