    ...
    <main className="min-h-screen bg-[#0a0e1a] text-white">
      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-300">
                We now offer a simpler setup flow — no Intuit developer account
                needed. Just install the extension and connect your QuickBooks
                with one click.
              </p>
              <a
                href="/dashboard"
        ...
        <p className="mt-3 text-lg text-gray-400">
          For developers who want to use their own Intuit OAuth credentials.
        ...
        <div className="mt-8 flex items-center gap-2">
          {steps.map((_, i) => (
            <div key={i} className="flex items-center gap-2 flex-1">
              ...
              {i < steps.length - 1 && (
                <div
                  className={`h-px flex-1 ${currentStep > i + 1 ? "bg-green-500" : "bg-white/10"}`}
                />
              )}
            </div>
          ))}
          ...
          <div className="mt-10 space-y-6">
            <div className="rounded-2xl border border-cyan-400/20 bg-cyan-400/5 p-8">
              ...
              <p className="mt-2 text-gray-400">
                This key unlocks all 131 QuickBooks tools. Keep it somewhere
              ...
              {licenseKey ? (
                ...
                <div className="mt-5 rounded-lg border border-yellow-400/20 bg-yellow-400/5 p-4 text-sm text-yellow-300">
                  No license key detected. Check your email or the checkout
                  success page for your key (starts with{" "}
                  <code className="bg-white/10 px-1 rounded">LK-</code>).
                </div>
              )}
            </div>
            <button
        ...
        {currentStep === 2 && (
          <div className="mt-10 space-y-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
              <h2 className="text-xl font-semibold">
                Step 2: Create a QuickBooks Developer App
              </h2>
              <p className="mt-2 text-gray-400">
                You need API credentials from Intuit to let AccountingQB read
                your QuickBooks data. This takes about 2 minutes.
              </p>

              <ol className="mt-6 space-y-5 text-gray-300">
                <li className="flex gap-4">
                  <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-blue-600/20 text-blue-400 text-sm font-bold">
                    a
                  </span>
                  <div>
                    <p>
                      ...
                      and sign in with your Intuit account (same one you use for
                      QuickBooks).
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    <p>
                      Click <strong className="text-white">Dashboard</strong> →{" "}
                      <strong className="text-white">Create an app</strong>.
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    <p>
                      ...
                      . Name it anything (e.g. &quot;AccountingQB&quot;).
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    <p>
                      ...
                      → <strong className="text-white">Production</strong>, copy
                      your:
                    </p>
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    <p>
                      Under{" "}
                      <strong className="text-white">Redirect URIs</strong>,
                      add:
                    </p>
                    <code className="mt-1 block rounded-lg bg-black/40 px-3 py-2 text-sm text-cyan-400">
                      https://accountingqb.com/api/oauth/callback
                    </code>
                  </div>
                </li>
              </ol>
        ...
        {currentStep === 3 && (
          <div className="mt-10 space-y-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
              <h2 className="text-xl font-semibold">
                Step 3: Connect Your QuickBooks Company
              </h2>
              <p className="mt-2 text-gray-400">
                Authorize AccountingQB to access your QuickBooks data. With this
                self-hosted setup, your data stays on your machine — we never
              ...
              <div className="mt-6 rounded-xl border border-green-400/20 bg-green-400/5 p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-gray-300">
                    ...
                    <p className="mt-1">
                      With this setup, OAuth tokens are stored locally on your
                      computer only. QuickBooks data is fetched directly from
                      your machine to Intuit&apos;s API — it never passes
                      through our servers.
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-6 space-y-4">
                <p className="text-gray-300">
                  Once you have the MCP server installed (next step), connect by
                  running the OAuth flow. With this setup, the server will guide
                  you through authorizing access and will automatically save
                  your tokens locally.
                </p>
                <p className="text-gray-300">
                  You&apos;ll need your{" "}
                  <strong className="text-white">Company ID (Realm ID)</strong>{" "}
                  — find it in your QuickBooks URL after{" "}
                  <code className="rounded bg-white/10 px-1.5 py-0.5 text-sm">
                    app.qbo.intuit.com/app/
                  </code>
                  .
                </p>
              </div>
        ...
        {currentStep === 4 && (
          <div className="mt-10 space-y-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="mt-2 text-gray-400">
                Add this MCP server configuration to your Claude Desktop
                settings. Replace the example values with your actual
                credentials.
              </p>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <p className="text-gray-300">
                      ...
                      <code className="rounded bg-black/40 px-2 py-1 text-cyan-400">
                        ~/Library/Application
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm text-gray-400">
                      Add this to the config (merge with existing if you have
                      other servers):
                    </p>
                    <button
                      onClick={() =>
                        copyToClipboard(mcpConfig, setCopiedConfig)
                      }
                ...
                <div className="rounded-xl border border-blue-400/20 bg-blue-400/5 p-5 text-sm">
                  ...
                  <ul className="mt-2 space-y-1 text-gray-300">
                    ...
                    <li>
                      •{" "}
                      <code className="text-cyan-400">
                        YOUR_INTUIT_CLIENT_SECRET
                      </code>{" "}
                      — from Step 2
                    </li>
                    <li>
                      • <code className="text-cyan-400">YOUR_COMPANY_ID</code> —
                      from your QuickBooks URL
                    </li>
                    <li>
                      •{" "}
                      <code className="text-cyan-400">YOUR_REFRESH_TOKEN</code>{" "}
                      — from the OAuth flow in Step 3
                    </li>
                  </ul>
                </div>
              </div>
