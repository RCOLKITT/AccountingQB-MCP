...
const faqs = [
  ...
  },
  {
    ...
    a: "You keep access to 25 essential read-only tools for free. To continue using all 109 tools including writes, tax prep, and advanced analytics, choose a paid plan.",
  },
  {
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-24 sm:pt-32 lg:pt-40">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-400 sm:text-xl">
              109 tools connecting Claude to your QuickBooks Online. Run reports,
          ...
          <div className="mt-20 grid gap-8 sm:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: "Ask Claude anything. \"What's my burn rate?\" \"Find missing deductions.\" 109 tools ready.",
      ...
      <section className="relative border-y border-white/[0.06] bg-[#0c1120] py-28">
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-gray-400">
              109 tools means 109 tasks that used to be manual. Tax prep, invoice reconciliation, vendor cleanup, anomaly checks, month-end close — all in a conversation.
            </p>
          </div>
            ...
            <div className="grid items-center gap-8 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-3 text-gray-400">
                  ...
                  anomaly checks, tax prep — 109 tools covering every workflow that eats your margin.
                </p>
              </div>
