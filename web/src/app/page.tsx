...
const faqs = [
  ...
  },
  {
    ...
    a: "You keep access to 25 essential read-only tools for free. To continue using all 132 tools including writes, tax prep, and advanced analytics, choose a paid plan.",
  },
  {
...
const TAX_DATA_FALLBACK: TaxData = {
  ...
  highlights: [
    ...
    {
      label: "Standard mileage — 70¢/mi (2025)",
...
export default async function Home() {
  const [publicStats, taxDataRaw, gitHubStars] = await Promise.all([
    getPublicStats(),
    getTaxData(),
    getGitHubStars(),
  ]);
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-24 sm:pt-32 lg:pt-40">
          <div className="text-center">
            ...
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3.5 py-1.5 text-[13px] text-gray-300">
              ...
              Connects to QuickBooks Online &middot; Claude, Cowork, or the
              desktop app
            </div>
            ...
            <h1 className="mx-auto max-w-3xl text-4xl font-bold leading-[1.08] tracking-tight text-white sm:text-6xl">
              ...
              <span className="font-serif font-medium italic text-cyan-300">
                tax workpapers you can defend.
              </span>
            </h1>

            {/* Subhead */}
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-400 sm:text-xl">
              132 tools connecting Claude to your QuickBooks Online. Run
              reports, reconcile books, prep for taxes, detect anomalies — all
              through natural conversation.{" "}
              <span className="text-gray-300">
                Run it locally or connect instantly — we never store your books.
              </span>
            </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-end">
                    <div className="max-w-md rounded-2xl rounded-br-md bg-blue-600/90 px-4 py-2.5 text-sm text-white">
                      What&apos;s my burn rate and how many months of runway do
                      I have?
                    </div>
                  </div>
                  {/* AI response */}
                    ...
                    <div className="max-w-md space-y-2">
                      <div className="rounded-2xl rounded-tl-md bg-[#161d33] px-4 py-3 text-sm text-gray-300">
                        ...
                        <p className="mt-2 text-xs text-gray-400">
                          Burn decreased 3.2% vs last quarter. At this rate you
                          have over a year of runway. Top expenses: Hosting
                          ($890), Software ($680), Marketing ($520).
                        </p>
                      </div>
      ...
      <section className="relative border-y border-white/[0.06] bg-[#0c1120]">
        <div className="mx-auto max-w-6xl px-6 py-8">
          ...
          <p className="mb-6 text-center text-[12px] uppercase tracking-[0.15em] text-gray-500">
            Built for solo owners, growing businesses, and bookkeeping firms —
            in the US &amp; Canada
          </p>
          ...
          {publicStats &&
            publicStats.activeLicenses >= USAGE_TILES_MIN_LICENSES && (
              <div className="mt-8 flex flex-col items-center justify-center gap-6 border-t border-white/[0.06] pt-8 sm:flex-row sm:gap-12">
                {publicStats.totalHoursSaved > 0 && (
                  <div className="text-center">
                    <div className="text-3xl font-bold text-cyan-400">
                      {publicStats.totalHoursSaved.toLocaleString()}
                    </div>
                ...
                {publicStats.totalToolCalls > 0 && (
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-400">
                      {publicStats.totalToolCalls.toLocaleString()}
                    </div>
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-400">
                    {publicStats.activeLicenses.toLocaleString()}
                  </div>
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-gray-400">
              Reports. Tax prep. Reconciliation. Invoicing. Forecasting.
              Compliance. Built by an entrepreneur who needed every single one.
            </p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
            {[
              ...
              {
                count: "13",
                label: "Modify, Delete & Bulk",
                color: "text-gray-400 border-gray-500/20 bg-gray-500/[0.06]",
              },
              {
                count: "8",
                label: "Entity Management",
                color:
                  "text-indigo-400 border-indigo-500/20 bg-indigo-500/[0.06]",
              },
              {
                count: "7",
                label: "Reconciliation",
                color: "text-rose-400 border-rose-500/20 bg-rose-500/[0.06]",
              },
              {
                count: "6",
                label: "Smart Bookkeeping",
                color:
              ...
              },
              {
                ...
                color: "text-green-400 border-green-500/20 bg-green-500/[0.06]",
              },
              {
                count: "3",
                label: "Close & Audit",
                color:
                  "text-orange-400 border-orange-500/20 bg-orange-500/[0.06]",
              },
              {
                count: "3",
                label: "Connection & Multi-Company",
                color: "text-teal-400 border-teal-500/20 bg-teal-500/[0.06]",
              },
            ].map((cat) => (
              <div
                key={cat.label}
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="gradient-border rounded-2xl p-8 sm:col-span-2 lg:col-span-2">
              ...
              <h3 className="text-xl font-semibold text-white">
                Email Invoice Scanning + Auto-Reconciliation
              </h3>
              <p className="mt-2 text-gray-400">
                Extract invoices from your email, then match them against
                QuickBooks transactions with fuzzy amount matching and date
                tolerance. Instantly find what&apos;s been paid, what&apos;s
                missing, and what doesn&apos;t add up — no more manual
                cross-referencing between your inbox and your books.
              </p>
              <div className="mt-6 grid grid-cols-3 gap-2 text-xs">
                <div className="rounded-lg bg-white/[0.04] px-3 py-2 text-center text-gray-400">
                  Extract from email
                </div>
                <div className="rounded-lg bg-white/[0.04] px-3 py-2 text-center text-gray-400">
                  Fuzzy matching
            ...
            <div className="gradient-border rounded-2xl p-8">
              ...
              <h3 className="text-xl font-semibold text-white">
                We Never Store Your Books
              </h3>
              <p className="mt-2 text-gray-400">
                Run it 100% locally — the MCP server runs on your machine and
                talks directly to QuickBooks, so your books never touch our
                servers. Or connect instantly through our zero-retention cloud
                connector — data transits, never stored.
              </p>
              <div className="mt-6 rounded-lg border border-green-500/10 bg-green-500/[0.04] px-3 py-2 text-xs text-green-400/80">
                Local: your machine → QuickBooks API
                <br />
            ...
            <div className="gradient-border rounded-2xl p-8">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500/20 to-indigo-600/20">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.130.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 01.865-.501 48.172 48.172 0 003.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z"
                  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-white">
              ...
              <p className="mt-2 text-gray-400">
                Ask Claude natural questions: &ldquo;What did I spend on
                software last quarter?&rdquo; or &ldquo;Am I missing any tax
                deductions?&rdquo;
              </p>
            </div>
            ...
            <div className="gradient-border rounded-2xl p-8">
              ...
              <p className="mt-2 text-gray-400">
                US &amp; Canada: Schedule C mapping, quarterly estimates,
                deduction finder, 1099 reports, home office &amp; vehicle
                calculators — plus GST/HST return workpapers, T2125, CCA
                schedules, T4A reports, and CRA instalments.
              </p>
            </div>
            ...
            <div className="gradient-border rounded-2xl p-8">
              ...
              <p className="mt-2 text-gray-400">
                Auto-categorization suggestions, duplicate detection, unknown
                vendor cleanup, anomaly flagging, bulk vendor updates, and a
                books health audit scored 0-100.
              </p>
            </div>
            ...
            <div className="gradient-border rounded-2xl p-8">
              ...
              <p className="mt-2 text-gray-400">
                A click-through year-end binder your accountant can file from:
                comparative statements, trial balance, reconciliation tie-outs,
                tax payments made, owner&apos;s draws, open items, and a
                built-in tax organizer. Export to Excel in one message.
              </p>
            </div>
          </div>
          ...
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <div>
              ...
              <h2 className="max-w-md text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-[1.1]">
                Every tax figure is{" "}
                <span className="font-serif font-medium italic text-cyan-300">
                  sourced, dated, and audit-logged.
                </span>
              </h2>
              <p className="mt-5 max-w-lg text-[15.5px] leading-relaxed text-gray-400">
                Bracket, mileage rate, §179 cap, GST/HST, CPP ceiling — every
                value lives in a versioned registry carrying its{" "}
                <span className="text-gray-200">official source</span> and a{" "}
                <span className="text-gray-200">verification date</span>.
                Changes ship through a tamper-evident, hash-chained ledger
                reviewed by a human, and a research agent re-checks every source
                for new legislation — including the 2025 OBBBA changes.
              </p>
              ...
              <p className="mt-5 text-[13px] text-gray-500">
                ...
                for the full, live provenance table.
              </p>
            </div>
                ...
                {taxData.highlights.slice(0, 3).map((h) => (
                  ...
                  >
                    ...
                    <div className="font-mono text-[12px] text-gray-500">
                      {h.jurisdiction} · sourced
                    </div>
                  </div>
                ))}
              </div>
              <div className="mt-3 rounded-lg bg-black/30 px-3 py-2 font-mono text-[11px] text-gray-500">
                append-only, hash-chained ledger · TAX_DATA v{taxData.version} ·
                verified {taxData.verified}
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="mt-20 grid gap-8 sm:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: 'Ask Claude anything. "What\'s my burn rate?" "Find missing deductions." 132 tools ready.',
              ...
              <div key={s.step} className="group relative">
                <div className="gradient-border rounded-2xl p-8 transition duration-300 hover:bg-white/[0.02]">
                  <div
                    className={`mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${s.gradient} bg-opacity-10 text-2xl font-bold text-white/90`}
                    style={{
                      background: `linear-gradient(135deg, rgba(34,211,238,0.1), rgba(59,130,246,0.1))`,
                    }}
                  >
                    <span
                      className={`bg-gradient-to-br ${s.gradient} bg-clip-text text-transparent`}
                    >
                      {s.step}
                    </span>
                  </div>
            ...
            {[
              {
                ...
                example:
                  '"Generate my Schedule C and find any deductions I missed this year."',
              },
              {
                ...
                example:
                  '"Match these invoices from my email against QB and show me any gaps."',
              },
              {
                ...
                example:
                  '"Run my month-end close for February and show me what needs fixing."',
              },
              {
                ...
                example:
                  '"What does my cash flow look like for the next 6 months?"',
              },
              {
                ...
                example:
                  '"Check Q4 for any suspicious transactions or duplicates."',
              },
              {
                ...
                tagColor: "text-cyan-400 bg-cyan-500/10 border-cyan-500/20",
                example:
                  '"Show me sales by customer for Q2, then drill into the biggest one."',
              },
              {
                ...
                example:
                  '"Create an invoice for Acme Corp for $5,000 consulting, due in 30 days."',
              },
              {
                title: "CPA Handoff",
              ...
              <div
                key={uc.title}
                className="gradient-border rounded-2xl p-8 transition duration-300 hover:bg-white/[0.02]"
              >
                <span
                  className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium ${uc.tagColor}`}
                >
                  {uc.tag}
                </span>
      ...
      <section className="relative border-y border-white/[0.06] bg-[#0c1120] py-28">
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-gray-400">
              132 tools means 131 tasks that used to be manual. Tax prep,
              invoice reconciliation, vendor cleanup, anomaly checks, month-end
              close — all in a conversation.
            </p>
          </div>
            ...
            {[
              {
                ...
                detail:
                  "Schedule C, deductions, 1099s, quarterly estimates, depreciation, home office, GST/HST, T2125, CCA — all from one prompt",
                icon: (
                  <svg
                    className="h-6 w-6 text-amber-400"
                    fill="none"
              ...
              },
              {
                ...
                detail:
                  "Extract invoices from email, match against QB, find gaps — replaces hours of manual cross-referencing",
                icon: (
                  <svg
                    className="h-6 w-6 text-rose-400"
                    fill="none"
              ...
              },
              {
                ...
                detail:
                  "Month-end close, categorization, reconciliation, vendor cleanup, anomaly checks — all automated",
                icon: (
                  <svg
                    className="h-6 w-6 text-cyan-400"
                    fill="none"
          ...
          <div className="mt-16">
              ...
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-white/[0.06] bg-[#131a2e]">
                    ...
                    <th className="px-6 py-4 text-center font-medium text-gray-400">
                      Manual time
                    </th>
                    <th className="px-6 py-4 text-center font-medium text-cyan-400">
                      AccountingQB
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-white/[0.04]">
                  {[
                    {
                      task: "Categorize & map expenses to Schedule C / T2125 lines",
                      manual: "3–5 hours",
                      fast: "~2 seconds",
                    },
                    {
                      task: "Scan for missed deductions across all categories",
                      manual: "2–3 hours",
                      fast: "~2 seconds",
                    },
                    {
                      task: "1099 / T4A contractor prep — pull payments, flag missing W-9s",
                      manual: "2–4 hours",
                      fast: "~2 seconds",
                    },
                    {
                      task: "Calculate quarterly estimates & CRA instalments",
                      manual: "1–2 hours",
                      fast: "~2 seconds",
                    },
                    {
                      task: "MACRS & CCA depreciation schedules (Section 179 analysis)",
                      manual: "1–2 hours",
                      fast: "~2 seconds",
                    },
                    {
                      task: "Extract invoices from email/Drive & reconcile against QB",
                      manual: "2–4 hours",
                      fast: "~30 seconds",
                    },
                  ].map((row) => (
                    <tr
                      key={row.task}
                      className="bg-[#0f1629] transition hover:bg-white/[0.02]"
                    >
            ...
            <p className="mt-4 text-center text-sm text-gray-500">
              A CPA charges $150–300/hr for this same output. AccountingQB
              starts at $39/mo.
            </p>
          </div>
          ...
          <div className="mt-12 rounded-2xl border border-white/[0.06] bg-[#131a2e] p-8">
            <div className="grid items-center gap-8 sm:grid-cols-2">
              <div>
                <h3 className="text-xl font-semibold text-white">
                  Built for bookkeeping firms
                </h3>
                <p className="mt-3 text-gray-400">
                  If you&apos;re managing 20+ clients, your team is spending
                  hundreds of hours a month on tasks AccountingQB handles in
                  minutes. Invoice reconciliation, month-end close, vendor
                  cleanup, anomaly checks, tax prep — 132 tools covering every
                  workflow that eats your margin.
                </p>
              </div>
              <div className="rounded-xl bg-white/[0.03] p-6">
                <div className="text-sm text-gray-500">
                  Example: 20-client firm
                </div>
      ...
      <section className="relative border-t border-white/[0.06] bg-[#0a0e1a] py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-center gap-4 px-6 sm:flex-row sm:gap-8">
          ...
          <span className="text-[13px] text-gray-500">
            Public source &middot; audit the code yourself
          </span>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-[15.5px] leading-relaxed text-gray-400">
              Two ways to run it — both designed so your books never become our
              asset. The less we hold, the less there is to breach: that&rsquo;s
              the architecture, not a compliance checkbox.
            </p>
          </div>
      ...
      <section className="relative border-t border-white/[0.06] bg-[#0c1120] py-28">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-gray-400">
            Join entrepreneurs who are saving hours every week on bookkeeping
            and tax prep.
          </p>
          <a
            href="#pricing"
