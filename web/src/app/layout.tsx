...
export const metadata: Metadata = {
  ...
  description:
    "126 AI tools connecting Claude to your QuickBooks Online. Run reports, reconcile books, prep US & Canadian taxes, detect anomalies — all through natural conversation. Runs locally or through our zero-retention connector — we never store your books.",
  keywords: [
    "quickbooks ai",
    "claude quickbooks",
    "mcp server",
  ...
  openGraph: {
    ...
    description:
      "126 AI tools connecting Claude to your QuickBooks Online. Run it locally or via our zero-retention connector — we never store your books. 14-day free trial.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "AccountingQB — AI-Powered QuickBooks for Claude",
    description:
      "126 AI tools connecting Claude to your QuickBooks Online. Runs locally or via our zero-retention connector — we never store your books.",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description:
      "126 AI tools connecting Claude to your QuickBooks Online for automated bookkeeping, tax prep, and financial analysis for US and Canadian businesses.",
    offers: [
      {
        "@type": "Offer",
        name: "Solopreneur",
