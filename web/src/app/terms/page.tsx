    ...
    <main className="min-h-screen bg-white">
      ...
      <article className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="prose prose-gray mt-12 max-w-none">
          <h2 className="text-xl font-semibold mt-10 mb-4">1. Agreement to Terms</h2>
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4">4. Account Registration</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4">5. Free Trial</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4">6. Subscription and Payment</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4">7. License and Restrictions</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4">8. Your Data and Privacy</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4">9. QuickBooks Integration</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4">10. Disclaimer of Warranties</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4">11. Limitation of Liability</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4">12. Indemnification</h2>
          <p className="text-gray-600 leading-relaxed">
