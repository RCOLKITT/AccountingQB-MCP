...
const faqs: { q: string; a: string }[] = [
  {
    ...
    a: "AccountingQB is an AI-powered QuickBooks Online integration for Claude. It gives Claude 132 tools to run financial reports, clean up bookkeeping, reconcile accounts, and prepare US and Canadian taxes through natural conversation. It connects to QuickBooks Online over the Model Context Protocol (MCP) — as a downloadable desktop app, a Claude Desktop extension, or a hosted connector.",
  },
  {
  ...
  },
  {
    ...
    a: "132 tools spanning financial reports (P&L, balance sheet, cash flow, general ledger, AR/AP aging, sales by customer/product/class), bookkeeping cleanup (uncategorized transactions, duplicates, anomaly detection, a structural books-hygiene audit), reconciliation, sales-tax economic-nexus screening, and full US and Canadian tax preparation.",
  },
  {
  ...
  },
  {
    ...
    a: "Three plans: Solopreneur at $39/month, Business at $99/month, and Firm at $299/month (with CAD pricing for Canadian customers), each with a 14-day free trial. After the trial you keep 25 essential read-only tools for free; paid plans unlock all 132 tools including writes, tax prep, and advanced analytics.",
  },
  {
  ...
  },
  {
    ...
    a: "It is the most comprehensive QuickBooks MCP server for Claude — 132 tools versus a handful in typical integrations — it uniquely covers both US and Canadian tax prep with sourced, dated tax data, and its connector is current with the 2026-07-28 MCP specification: stateless, load-balancer-ready, and using none of the deprecated protocol features.",
  },
];
