...
def test_register_pairs_contra_and_excludes_land(monkeypatch):
    _patch(monkeypatch, [
        {"Name": "Furniture & Fixtures", "CurrentBalance": 2526.0, "AccountType": "Fixed Asset"},
        {"Name": "Accumulated Depreciation - Furniture", "CurrentBalance": -2555.0, "AccountType": "Fixed Asset"},
        {"Name": "Computers", "CurrentBalance": 3000.0, "AccountType": "Fixed Asset"},
