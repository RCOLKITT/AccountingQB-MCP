        ...
        "Row": [
            {
                ...
                "Summary": {
                    "ColData": [{"value": "Total Income"}, {"value": "156.00"}]
                },
            },
            {
                ...
                "Summary": {
                    "ColData": [{"value": "Total Expenses"}, {"value": "20090.02"}]
                },
            },
            {
                ...
                "Summary": {
                    "ColData": [{"value": "Total Other Income"}, {"value": "0.76"}]
                },
            },
        ]
    }
    ...
    pl = {
        "Rows": {
            "Row": [
                ...
                {
                    "Summary": {
                        "ColData": [{"value": "Total Expenses"}, {"value": "0.00"}]
                    }
                },
            ]
        }
...
def test_missing_receipts_excludes_card_payment_and_interest():
    ...
    with patch.object(s, "qb_query_all", fake_query_all):
        out = asyncio.run(
            _unwrap(s.qb_missing_receipts)(75.0, "2026-01-01", "2026-12-31")
        )
    ...
    pl = {
        "Rows": {
            "Row": [
                ...
                {
                    "Summary": {
                        "ColData": [{"value": "Net Other Income"}, {"value": "0.76"}]
                    }
                },
            ]
        }
...
def test_server_info_deployment_mode_is_static():
    ...
    for mutated in (False, True):  # expired, then after a hosted-token load
        with (
            patch.object(s, "qb_query", noconn),
            patch.object(s, "_HOSTED_CONNECTOR", False),
            ...
            out = asyncio.run(_unwrap(s.qb_server_info)())
        assert (
            "Deployment:** hosted connector" in out
...
def test_schedule_c_meals_limit_and_allocation_warning():
            ...
            "Row": [
                {
                    ...
                    "Rows": {
                        "Row": [
                            {"ColData": [{"value": "Sales"}, {"value": "50000.00"}]}
                        ]
                    },
                    "Summary": {
                ...
                },
                {
                    ...
                    "Summary": {
                        "ColData": [{"value": "Total Expenses"}, {"value": "1911.13"}]
                    },
                },
            ]
        }
    ...
    accts = [
        {
            "Name": "Business meals",
            "AccountSubType": "TravelMeals",
            "FullyQualifiedName": "Business meals",
        },
        {
            "Name": "Cell phone",
            "AccountSubType": "Utilities",
            "FullyQualifiedName": "Cell phone",
        },
    ]
...
def test_home_office_subaccounts_route_by_parent_chain():
        ...
        "Rows": {
            "Row": [
                ...
                },
                {
                    ...
                    "Summary": {
                        "ColData": [{"value": "Total Expenses"}, {"value": "7910.08"}]
                    },
                },
            ]
        }
    ...
    accts = [
        ...
        },
        {
            ...
            "FullyQualifiedName": "Home office:Mortgage interest",
        },
        {
            "Name": "Property taxes",
            "AccountSubType": "OtherMiscellaneousExpense",
        ...
        },
        {
            ...
            "FullyQualifiedName": "Home office:Repairs & maintenance",
        },
        {
            "Name": "Home utilities",
            "AccountSubType": "Utilities",
            "FullyQualifiedName": "Home office:Home utilities",
        },
    ]
...
def test_t2125_applies_allocation_home_and_vehicle():
            ...
            "Row": [
                {
                    ...
                    "Rows": {
                        "Row": [
                            {"ColData": [{"value": "Sales"}, {"value": "20000.00"}]}
                        ]
                    },
                    "Summary": {
                        "ColData": [{"value": "Total Income"}, {"value": "20000.00"}]
                    },
                },
                {
                    "Header": {"ColData": [{"value": "Expenses"}]},
                    ...
                    "Summary": {
                        "ColData": [{"value": "Total Expenses"}, {"value": "4600.00"}]
                    },
                },
            ]
        }
    ...
    accts = [
        ...
        },
        {
            "Name": "Motor vehicle",
            "AccountSubType": "Auto",
            "FullyQualifiedName": "Motor vehicle",
        },
        {
            "Name": "Property taxes",
            "AccountSubType": "OtherMiscellaneousExpense",
        ...
        },
        {
            "Name": "Utilities",
            "AccountSubType": "Utilities",
            "FullyQualifiedName": "Home office:Utilities",
        },
    ]
    ...
    async def fake_query(q):
        return {
            "QueryResponse": {
                "CompanyInfo": [{"CompanyName": "Maple Co", "Country": "CA"}]
            }
        }

    async def fake_profile(y):
        return {
            "home_office": {"percentage": 0.20, "basis_note": "300/1500 sqft"},
            "vehicle": {
                "method": "actual",
                "percentage": 0.60,
...
def test_owner_draws_excludes_opening_balance_equity():
    ...
    async def fake_req(m, p, params=None, **k):
        ...
        return (
            obe_gl
            if acct_id == "20"
            else owner_gl if acct_id == "13" else {"Rows": {"Row": []}}
        )
...
def test_home_indirect_duplicate_leaf_and_inactive():
            ...
            "Row": [
                {
                    ...
                    "Rows": {
                        "Row": [
                            {"ColData": [{"value": "Sales"}, {"value": "80000.00"}]}
                        ]
                    },
                    "Summary": {
                ...
                },
                {
                                ...
                                "Rows": {
                                    "Row": [
                                        ...
                                        },
                                        {
                                            "ColData": [
                                                {
                                                    "value": "Mortgage interest (deleted)"
                                                },
                                                {"value": "3613.41"},
                                            ]
                                        },
                    ...
                    "Summary": {
                        "ColData": [{"value": "Total Expenses"}, {"value": "9162.12"}]
                    },
                },
            ]
        }
    ...
    accts = [
        ...
        {
            "Name": "Mortgage interest (deleted)",
            "AccountSubType": "InterestPaid",
            "FullyQualifiedName": "Home office:Mortgage interest (deleted)",
            "Active": False,
        },
        {
            "Name": "Property taxes",
    ...
    assert (
        "3,613.41" not in out.split("× 12.50%")[0]
    )  # not deducted in full anywhere above home
    assert "Does not reconcile" not in out
...
def test_list_vendors_discloses_truncation_and_pages_all():
    ...
    vendors = [
        {"Id": str(i), "DisplayName": f"Vendor {i:03d}", "Active": True}
        for i in range(60)
    ]
    seen = {}
    ...
    with (
        patch.object(s, "qb_query_all", fake_query_all),
        patch.object(s, "qb_query", fake_query),
        ...
        "Rows": {
            "Row": [
                ...
                },
                {
                    ...
                    "Summary": {
                        "ColData": [{"value": "Total Expenses"}, {"value": "1000.00"}]
                    },
                },
            ]
        }
    ...
    accts = [
        {
            "Name": "Cell phone",
            "AccountSubType": "Utilities",
            "FullyQualifiedName": "Communications:Cell phone",
            "Active": True,
        }
    ]
            ...
            "Row": [
                {
                    "Header": {"ColData": [{"value": "Income"}]},
                    "Rows": {
                        "Row": [{"ColData": [{"value": "Sales"}, {"value": "5000.00"}]}]
                    },
                    "Summary": {
                ...
                },
                {
                    ...
                    "Summary": {
                        "ColData": [{"value": "Total Expenses"}, {"value": "11500.00"}]
                    },
                },
            ]
        }
