...
ACCOUNTS = [
    {"Id": "2", "Name": "Services", "FullyQualifiedName": "Services", "AccountType": "Income"},
    {"Id": "44", "Name": "Legal & accounting services",
     "FullyQualifiedName": "Legal & accounting services", "AccountType": "Expense"},
    {"Id": "10", "Name": "Hotels", "FullyQualifiedName": "Travel:Hotels", "AccountType": "Expense"},
    {"Id": "20", "Name": "Office Supplies", "FullyQualifiedName": "Office Supplies", "AccountType": "Expense"},
    {"Id": "21", "Name": "Office Rent", "FullyQualifiedName": "Office Rent", "AccountType": "Expense"},
]
...
def _fake_qb_query(accounts):
    async def fake(q):
        ...
        if "Name LIKE" in q:
            ...
            res = [a for a in accounts if a.get("FullyQualifiedName") == val and keep(a)]
        elif "Name =" in q:
...
def test_je_rejects_unknown_line_key(monkeypatch):
    ...
    monkeypatch.setattr(s, "qb_query", _fake_qb_query(ACCOUNTS))
    out = asyncio.run(s.qb_create_journal_entry(
        "2026-01-01", '[{"account_name":"Services","amount":100,"posting_type":"Debit"}]'))
...
def test_create_account_rejects_long_description():
    out = asyncio.run(s.qb_create_account("Test Acct", "Expense", description="x" * 114))
