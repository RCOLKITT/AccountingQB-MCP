...
GOLDEN_ACCOUNTS = [
    ...
    },
    {
        ...
        "AccountType": "Expense",
        "AccountSubType": "Travel",
        "FullyQualifiedName": "Travel:Airfare",
        "Active": True,
    },
    ...
    # (7) mixed personal/business — an allocation candidate (utilities)
    {
        ...
        "FullyQualifiedName": "Internet & TV",
        "Active": True,
    },
    ...
    # what qb_deduction_finder was wrongly counting; keep it here so CI catches it)
    {
        ...
        "FullyQualifiedName": "Charitable contributions",
        "Active": True,
    },
    # (6) system + owner equity
    {
        ...
        "FullyQualifiedName": "Owner investments",
        "Active": True,
    },
    {
        "Id": "81",
            ...
            },
            {
                ...
                "Rows": {
                    "Row": [
                        ...
                        _leaf("Charitable contributions", 300.00),
                    ]
                },  # non-deductible (§170)
                "Summary": {
                    "ColData": [{"value": "Total Expenses"}, {"value": "10400.00"}]
                },
            },
        ]
    }
...
def _equity_gl(name, rows):
    return {
        **_GL_COLS,
        "Rows": {
            "Row": [{"Header": {"ColData": [{"value": name}]}, "Rows": {"Row": rows}}]
        },
    }
...
def patch_book(profile=None, region="US"):
    ...
    async def fake_req(m, p, params=None, **k):
        if "reports/GeneralLedger" in p:
            return GOLDEN_EQUITY_GL.get(
                (params or {}).get("account"), {"Rows": {"Row": []}}
            )
    ...
    async def fake_query(q):
        return {
            "QueryResponse": {
                "CompanyInfo": [{"CompanyName": "Golden Co", "Country": region}]
            }
        }
