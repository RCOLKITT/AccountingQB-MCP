...
_FED_BRACKETS = {
    2025: {
        ...
        "std_single": 15_750,
        "std_married": 31_500,  # OBBBA amounts
    },
    2026: {
...
_US_STATE_TAX = {
    ...
    "NH": (
        0.0,
        "none",
    ),  # no tax on earned income (interest/dividends tax repealed 2025)
    "AZ": (0.025, "flat"),
    "CO": (0.044, "flat"),
    ...
    "DC": (0.065, "progressive_approx"),
    "HI": (0.079, "progressive_approx"),
    "KS": (0.0558, "progressive_approx"),
    "MD": (0.0475, "progressive_approx"),
    "ME": (0.0715, "progressive_approx"),
    "MN": (0.0785, "progressive_approx"),
    "MO": (0.047, "progressive_approx"),
    "MT": (
        0.0565,
        "progressive_approx",
    ),  # top rate 5.65% effective Jan 1, 2026 (was 5.9%)
    "ND": (0.025, "progressive_approx"),
    "NE": (
        0.0455,
        "progressive_approx",
    ),  # top rate 4.55% effective Jan 1, 2026 (was 5.2%)
    "NJ": (0.0637, "progressive_approx"),
    "NM": (0.049, "progressive_approx"),
    ...
    "WV": (
        0.0458,
        "progressive_approx",
    ),  # all rates reduced; top 4.58% effective Jan 1, 2026 (was 4.82%)
}
...
_ACCOUNT_TAXONOMY = {
    ...
    "ServiceFeeIncome": {"us": "1", "ca": "8000", "us_1120s": "1a", "us_1065": "1a"},
    "OtherPrimaryIncome": {"us": "1", "ca": "8000", "us_1120s": "1a", "us_1065": "1a"},
    ...
    "InterestEarned": {"us": "6", "ca": "8230", "us_1120s": "K4", "us_1065": "K5"},
    "DividendIncome": {"us": "6", "ca": "8230", "us_1120s": "K5a", "us_1065": "K6a"},
    "TaxExemptInterest": {
        "us": "6",
        "ca": "8230",
        "us_1120s": "K16a",
    ...
    "SuppliesMaterialsCogs": {"us_1120s": "2", "us_1065": "2"},
    "CostOfLaborCos": {"us_1120s": "2", "us_1065": "2"},
    "EquipmentRentalCos": {"us_1120s": "2", "us_1065": "2"},
    "ShippingFreightDeliveryCos": {"us_1120s": "2", "us_1065": "2"},
    "OtherCostsOfServiceCos": {"us_1120s": "2", "us_1065": "2"},
    ...
    "Auto": {"us": "9", "ca": "9281", "us_1120s": "20", "us_1065": "21"},
    "CommissionsAndFees": {"us": "10", "ca": "9270", "us_1120s": "20", "us_1065": "21"},
    "PayrollExpenses": {"us": "26", "ca": "9060", "us_1120s": "8", "us_1065": "9"},
    "PayrollWageExpenses": {"us_1120s": "8", "us_1065": "9"},
    "PayrollTaxExpenses": {
        "us_1120s": "12",
        "us_1065": "14",
    },  # employer share → taxes & licenses
    "TaxesPaid": {"us_1120s": "12", "us_1065": "14"},
    "Insurance": {"us": "15", "ca": "8690", "us_1120s": "20", "us_1065": "21"},
    "InterestPaid": {"us": "16b", "ca": "8710", "us_1120s": "13", "us_1065": "15"},
    "FinanceCosts": {"us": "16b", "ca": "8710", "us_1120s": "13", "us_1065": "15"},
    "BankCharges": {"us": "27a", "ca": "8710", "us_1120s": "20", "us_1065": "21"},
    "BadDebts": {"us": "27a", "ca": "8590", "us_1120s": "10", "us_1065": "12"},
    ...
    "OfficeExpenses": {"us": "18", "ca": "8810", "us_1120s": "20", "us_1065": "21"},
    ...
    "DuesSubscriptions": {"us": "27a", "ca": "8760", "us_1120s": "20", "us_1065": "21"},
    "SuppliesMaterials": {"us": "22", "ca": "8811", "us_1120s": "20", "us_1065": "21"},
    ...
    "EquipmentRental": {"us": "20a", "ca": "8910", "us_1120s": "11", "us_1065": "13"},
    "RepairMaintenance": {"us": "21", "ca": "8960", "us_1120s": "9", "us_1065": "11"},
    "Travel": {"us": "24a", "ca": "9200", "us_1120s": "20", "us_1065": "21"},
    "TravelMeals": {
        "us": "24b",
        "ca": "8523",
        "us_1120s": "20_meals",
    ...
    "Entertainment": {
        ...
        "us_1065": "NONDED_274",  # 1065: Sch K item 18c
    ...
    "CharitableContributions": {
        ...
        "us_1120s": "K12a",
        "us_1065": "K13a",  # partnership: separately stated, flows to partners
    },  # sole-prop: Sch A / T1, not the business
    "Utilities": {"us": "25", "ca": "9220", "us_1120s": "20", "us_1065": "21"},
...
_SCHEDULE_C_CATALOG = {
    ...
    "NONDED_274": {
        "desc": "Entertainment — not deductible on Schedule C (IRC §274(a))",
        "mef": None,
    },
    "NONDED_170": {
        "desc": "Charitable contributions — not a Schedule C deduction; a sole proprietor claims them on Schedule A (IRC §170)",
        "mef": None,
    },
    "NONDED_162E": {
...
# Form 1065 (partnership) — page-1 lines + separately-stated Schedule K items.
# Line numbers verified against the current IRS Instructions for Form 1065
# (i1065), 2026-09-01: guaranteed payments to partners at line 10 (the
# partnership-specific deduction), §179D at 20, Other deductions 21, ordinary
# business income 23. Sch K: interest 5, dividends 6a, charitable 13a,
# tax-exempt 18a, nondeductible 18c, distributions 19a.
_IRS_1065 = "https://www.irs.gov/instructions/i1065"
...
_1065_CATALOG = {
    ...
    "2": {"desc": "Cost of goods sold (Form 1125-A)", "mef": None},
    "4": {
        "desc": "Ordinary income (loss) from other partnerships/estates/trusts",
        "mef": None,
    },
    "5": {"desc": "Net farm profit (loss)", "mef": None},
    "6": {"desc": "Net gain (loss) from Form 4797", "mef": None},
    "7": {"desc": "Other income (loss)", "mef": None},
    "9": {"desc": "Salaries and wages (other than to partners)", "mef": None},
    "10": {"desc": "Guaranteed payments to partners", "mef": None},
    "11": {"desc": "Repairs and maintenance", "mef": None},
    "12": {"desc": "Bad debts", "mef": None},
    "13": {"desc": "Rent", "mef": None},
    "14": {"desc": "Taxes and licenses", "mef": None},
    "15": {"desc": "Interest", "mef": None},
    "16": {"desc": "Depreciation (Form 4562)", "mef": None},
    "17": {"desc": "Depletion", "mef": None},
    "18": {"desc": "Retirement plans, etc.", "mef": None},
    "19": {"desc": "Employee benefit programs", "mef": None},
    "20": {
        "desc": "Energy efficient commercial buildings deduction (Form 7205)",
        "mef": None,
    },
    "21": {"desc": "Other deductions", "mef": None},
    "21_meals": {
        "desc": "Meals within Other deductions — 50% deductible (IRC §274(n)); "
        "the disallowed half is a Schedule K line 18c nondeductible expense",
        "mef": None,
    },
    "23": {"desc": "Ordinary business income (loss)", "mef": None},
    "K5": {"desc": "Schedule K — Interest income (separately stated)", "mef": None},
    "K6a": {"desc": "Schedule K — Ordinary dividends (separately stated)", "mef": None},
    "K13a": {
        "desc": "Schedule K — Charitable contributions (separately stated; "
        "flows to partners, not an entity deduction)",
        "mef": None,
    },
    "K18a": {"desc": "Schedule K — Tax-exempt interest income", "mef": None},
    "K18c": {"desc": "Schedule K — Nondeductible expenses", "mef": None},
    "K19a": {"desc": "Schedule K — Distributions", "mef": None},
    "NONDED_274": {
        "desc": "Entertainment — not deductible (IRC §274(a)); a Schedule K "
        "line 18c nondeductible expense",
        "mef": None,
    },
    "NONDED_162E": {
        "desc": "Political contributions & lobbying — not deductible (IRC §162(e)); "
        "a Schedule K line 18c nondeductible expense",
        "mef": None,
    },
}
for _k, _v in _1065_CATALOG.items():
    _v["authority"], _v["cite"] = "IRS-1065", _IRS_1065
...
_T2125_CATALOG = {
    k: {"desc": v, "authority": "CRA-GIFI", "cite": _CRA_T2125}
...
_NAME_FALLBACK_US = [
    ...
    (
        r"pension|profit[- ]?sharing|401\(?k\)?|retirement plan|sep[- ]?ira|simple ira",
        "19",
    ),
    ...
    (
        ...
        r"(rent|lease).{0,12}(equipment|vehicle|machinery)",
        "20a",
    ),
    (r"rent|lease", "20b"),
...
# 1065: the same translation trick — one Schedule C pattern list, translated per
# form, so the fallbacks can never drift. Lines with no 1065 analogue go to 21.
_SCHC_TO_1065_LINE = {
    "1": "1a",
    "2": "1b",
    "6": "7",
    "8": "21",  # no advertising line on the 1065
    "9": "21",
    "10": "21",
    "11": "21",
    "12": "17",  # depletion
    ...
    "27a": "21",
    "NONDED_274": "NONDED_274",
    "NONDED_170": "K13a",  # partnership: charitable is separately stated
    "NONDED_162E": "NONDED_162E",
}
_NAME_FALLBACK_1065 = [
    (p, _SCHC_TO_1065_LINE.get(line, "21")) for p, line in _NAME_FALLBACK_US
]
...
_NAME_FALLBACK_COMPILED = {
    ...
    "us_1065": [
        (re.compile(r"\b(?:" + p + r")", re.I), line) for p, line in _NAME_FALLBACK_1065
    ],
}
_CATCH_ALL = {"us": "27a", "ca": "9270", "us_1120s": "20", "us_1065": "21"}
_CATALOG = {
    "us": _SCHEDULE_C_CATALOG,
    "ca": _T2125_CATALOG,
    "us_1120s": _1120S_CATALOG,
    "us_1065": _1065_CATALOG,
}
...
def classify_account(name: str, subtype: str, jurisdiction: str, form: str = ""):
    ...
    if juris == "us" and form_key == "1120s":
        juris = "us_1120s"
    elif juris == "us" and form_key == "1065":
        juris = "us_1065"
...
_STATUTORY_LIMITS = {
    ...
    "meals_us_1065": {
        "factor": 0.50,
        "line": "21_meals",  # 1065-only line id — no index clash
        "jurisdiction": "US",
        "cite": "IRC §274(n)",
        "since": "2023-01-01",
        "desc": "Business meals (1065) — 50% deductible; disallowed half → Sch K 18c",
    },
...
_LINE_LIMIT_INDEX = {
    (v["jurisdiction"].lower(), v["line"]): v for v in _STATUTORY_LIMITS.values()
}
...
_CCA_CLASSES = {
    ...
    "10.1": (
        0.30,
        "Passenger vehicles over the cost ceiling (one per class; "
...
TABLES: dict = {
    "SS_WAGE_BASE": dict(
        values=_SS_WAGE_BASE,
        year_keyed=True,
        jurisdiction="US-federal",
        kind="exact",
        description="Social Security wage base (SE tax OASDI cap)",
        source="SSA COLA fact sheet; Rev. Proc. 2025-32 context",
        source_url="https://www.ssa.gov/oact/cola/cbb.html",
        verified="2026-07-12",
        review="annual-december",
        sanity={"min": 100_000, "max": 500_000, "max_yoy_pct": 0.10},
    ),
    "FED_BRACKETS": dict(
        values=_FED_BRACKETS,
        year_keyed=True,
        jurisdiction="US-federal",
        kind="exact",
        description="Federal income tax bracket thresholds + standard deduction",
    ...
    "FED_RATES": dict(
        ...
        jurisdiction="US-federal",
        kind="stable_statute",
        description="Federal bracket rates (OBBBA made TCJA rates permanent)",
    ...
    "SE_TAX": dict(
        values={
            "net_earnings_factor": _SE_NET_EARNINGS_FACTOR,
            "ss_rate": _SE_SS_RATE,
            "medicare_rate": _SE_MEDICARE_RATE,
        },
        year_keyed=False,
        jurisdiction="US-federal",
        kind="stable_statute",
    ...
    "US_SALES_TAX_NEXUS": dict(
        values=_US_SALES_TAX_NEXUS,
        year_keyed=False,
        jurisdiction="US-state",
        kind="exact",
    ...
    "TCJA_PHASE_DOWN": dict(
        values=_TCJA_PHASE_DOWN,
        year_keyed=True,
        terminal_value=0.0,
        jurisdiction="US-federal",
        kind="stable_statute",
    ...
    "SUV_179_CAP": dict(
        ...
        jurisdiction="US-federal",
        kind="exact",
        description="Heavy SUV (6,001-14,000 lbs GVWR) Section 179 cap",
    ...
    "280F_LIMITS": dict(
        ...
        jurisdiction="US-federal",
        kind="exact",
        description="Luxury-auto (§280F) annual depreciation caps",
    ...
    "MACRS_5YR": dict(
        ...
        jurisdiction="US-federal",
        kind="stable_statute",
        description="MACRS 5-year property rates (200% DB, half-year)",
    ...
    "SEC_179_LIMITS": dict(
        values=_SEC_179_LIMITS,
        year_keyed=True,
        jurisdiction="US-federal",
        kind="exact",
        description="Section 179 expensing limit + phase-out threshold",
    ...
    "SEC_195": dict(
        ...
        jurisdiction="US-federal",
        kind="stable_statute",
        description="Startup cost immediate deduction / phase-out / amortization",
        source="IRC §195(b)",
    ...
    "HOME_OFFICE_SIMPLIFIED": dict(
        values=_HOME_OFFICE_SIMPLIFIED,
        year_keyed=False,
        jurisdiction="US-federal",
        kind="stable_statute",
    ...
    "STD_MILEAGE_CENTS": dict(
        values=_STD_MILEAGE_CENTS,
        year_keyed=True,
        jurisdiction="US-federal",
        kind="exact",
    ...
    "RETIREMENT_LIMITS": dict(
        values=_RETIREMENT_LIMITS,
        year_keyed=True,
        jurisdiction="US-federal",
        kind="exact",
    ...
    "NEC_1099_THRESHOLD": dict(
        values=_1099_NEC_THRESHOLD,
        year_keyed=True,
        jurisdiction="US-federal",
        kind="exact",
    ...
    "GST_QUICK_METHOD": dict(
        values={
            "limit": _GST_QUICK_METHOD_LIMIT,
    ...
    "MEALS_ITC_FACTOR": dict(
        values=_MEALS_ITC_FACTOR,
        year_keyed=False,
        jurisdiction="CA-federal",
        kind="stable_statute",
    ...
    "ACCOUNT_TAXONOMY": dict(
        values=_ACCOUNT_TAXONOMY,
        year_keyed=False,
        jurisdiction="US-federal",
        kind="stable_statute",
        description="QuickBooks AccountSubType -> IRS Schedule C line + CRA T2125/GIFI line + Form 1120-S line + Form 1065 line",
    ...
    "SCHEDULE_C_CATALOG": dict(
        values=_SCHEDULE_C_CATALOG,
        year_keyed=False,
        jurisdiction="US-federal",
        kind="stable_statute",
    ...
    "FORM_1065_CATALOG": dict(
        values=_1065_CATALOG,
        year_keyed=False,
        jurisdiction="US-federal",
        kind="stable_statute",
        description="Authoritative Form 1065 line catalog (page-1 lines + separately-stated Schedule K items)",
        source="IRS Instructions for Form 1065 (i1065); guaranteed payments line 10, §179D line 20, Other deductions 21, ordinary income 23",
        source_url="https://www.irs.gov/instructions/i1065",
        verified="2026-09-01",
        review="annual-january",
        sanity={},
    ),
    "T2125_CATALOG": dict(
        values=_T2125_CATALOG,
        year_keyed=False,
        jurisdiction="CA-federal",
        kind="stable_statute",
    ...
    "STATUTORY_LIMITS": dict(
        values=_STATUTORY_LIMITS,
        year_keyed=False,
        jurisdiction="US-federal",
        kind="stable_statute",
    ...
    "CCA_CLASSES": dict(
        ...
        jurisdiction="CA-federal",
        kind="stable_statute",
        description="CCA declining-balance classes and rates",
    ...
    "CLASS_10_1_CEILING": dict(
        values=_CLASS_10_1_CEILING,
        year_keyed=True,
        jurisdiction="CA-federal",
        kind="exact",
    ...
    "CLASS_54_ZEV_CEILING": dict(
        values=_CLASS_54_ZEV_CEILING,
        year_keyed=False,
        jurisdiction="CA-federal",
        kind="exact",
    ...
    "AII": dict(
        values={
            "start_year": _AII_START_YEAR,
            "first_year_factor": _AII_FIRST_YEAR_FACTOR,
        },
        year_keyed=False,
        jurisdiction="CA-federal",
        kind="stable_statute",
    ...
    "T4A_ADMIN_THRESHOLD": dict(
        values=_T4A_ADMIN_THRESHOLD,
        year_keyed=False,
        jurisdiction="CA-federal",
        kind="approximation",
    ...
    "CPP": dict(
        values={
            "params": _CPP_PARAMS,
            "basic_exemption": _CPP_BASIC_EXEMPTION,
            "rate_self": _CPP_RATE_SELF,
            "cpp2_rate_self": _CPP2_RATE_SELF,
        },
        year_keyed=True,
        jurisdiction="CA-federal",
        kind="exact",
        ...
        verified="2026-07-12",
        review="annual-december",
        sanity={"max_yoy_pct": 0.10},
    ),  # values mix rates and dollar ceilings
    "CA_FED_BRACKETS_APPROX": dict(
        values=_CA_FED_BRACKETS_APPROX,
        year_keyed=False,
        jurisdiction="CA-federal",
        kind="approximation",
        ...
        review="annual-december",
        sanity={},
    ),  # values mix bracket thresholds (dollars) and rates
    "CA_BPA_APPROX": dict(
        values=_CA_BPA_APPROX,
        year_keyed=False,
        jurisdiction="CA-federal",
        kind="approximation",
    ...
    "CA_PROV_FLAT_APPROX": dict(
        values=_CA_PROV_FLAT_APPROX,
        year_keyed=False,
        jurisdiction="CA-provincial",
        kind="approximation",
    ...
    "CRA_INSTALMENTS": dict(
        values={"dates": _CRA_INSTALMENT_DATES, "threshold": _CRA_INSTALMENT_THRESHOLD},
        year_keyed=False,
        jurisdiction="CA-federal",
        kind="stable_statute",
...
def public_tax_data() -> dict:
    ...
    if _STD_MILEAGE_CENTS:
        ...
        clean_years = [
            y
            for y in sorted(_STD_MILEAGE_CENTS, reverse=True)
